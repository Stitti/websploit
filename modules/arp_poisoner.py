...
def arp_poisoner():
    try:
        ...
        if com[0:13] == 'set interface':
            ...
            print((wcolors.color.BLUE + "[*]IP Forwarding ... " + wcolors.color.ENDC), end=' ')
            ...
            print((wcolors.color.BLUE + "[*]Configuring Iptables ... " + wcolors.color.ENDC), end=' ')
            ...
            sleep(0.5)
            print((wcolors.color.GREEN + "[OK]" + wcolors.color.ENDC))
            print((wcolors.color.BLUE + "[*]Redirect Traffic on %s ... " + wcolors.color.ENDC) % (options[3]), end=' ')
