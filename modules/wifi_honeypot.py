...
def wifi_honeypot():
    try:
        ...
        if com[0:13] == 'set interface':
            ...
            print((wcolors.color.GREEN+"[*]Enable monitor mod on your interface [%s] ..."+wcolors.color.ENDC)% (options[0]), end=' ')
            ...
            print((wcolors.color.GREEN+"[*]Creating Fake Access Point ..."+wcolors.color.ENDC), end=' ')
            if options[6]==1:
                os.system(comm1)
            elif options[6]==2:
                os.system(comm2)
